...
class AppointmentEmailHandler {
    ...
    public function __construct() {
        ...
        add_action('wp_ffcertificate_appointment_created_email', array($this, 'send_booking_confirmation'), 10, 2);
        add_action('wp_ffcertificate_appointment_admin_notification', array($this, 'send_admin_notification'), 10, 2);
        add_action('wp_ffcertificate_appointment_confirmed_email', array($this, 'send_approval_notification'), 10, 2);
        add_action('wp_ffcertificate_appointment_cancelled_email', array($this, 'send_cancellation_notification'), 10, 2);
        add_action('wp_ffcertificate_appointment_reminder_email', array($this, 'send_reminder'), 10, 2);
    }
